...
#### OUTPUT ####
# 1. Tensor & Device
#   CPU tensor: cpu, shape=torch.Size([1024, 1024])
#   GPU tensor: cuda:0, shape=torch.Size([1024, 1024])
#   Direct GPU: cuda:0
#   FP16 size: 2 bytes/elem
#   FP32 size: 4 bytes/elem
# 2. GPU Memory Management
#   Before alloc : 8.0 MB
#   After  alloc : 264.0 MB
#   After  delete: 8.0 MB
#   Total VRAM   : 8.0 GB
#
#  3. CPU vs GPU Speed
#   CPU matmul (4096x4096): 247.5 ms
#   GPU matmul (4096x4096): 18.649 ms  (13x faster)
#
# 4. CUDA Streams
#   Sequential : 4.56 ms
#   Parallel   : 5.79 ms  (0.79x)
#
#  5. CUDA Event Timing
# matmul 4096x4096: 16.806 ms  |  8178.0 GFLOPS
# relu   4096x4096: 0.409 ms
# add    4096x4096: 0.536 ms
#
# 6. FP32 vs FP16 (Tensor Core)
#   FP32: 17.009 ms  |  8080.4 GFLOPS
#   FP16: 3.926 ms  |  35011.2 GFLOPS  (4.3x)